...
4. EXTRA: Mary also plays basketball, and her team scored 97, 134 nd 105 points. 
...
console.log('John\'s team: ' + avgScoreJohn, 'Mike\'s team: ' + avgScoreMike, 'Mary\'s team: ' + avgScoreMary);

if (avgScoreJohn > avgScoreMike && avgScoreJohn > avgScoreMary) {
    console.log('John\'s team wins in average! Average score: ' + averageJohn);
} else if (avgScoreMike > avgScoreJohn && avgScoreMike > avgScoreMary) {
    console.log('Mike\'s team wins in average! Average score: ' + avgScoreMike);
} else if (avgScoreMary > avgScoreJohn && avgScoreMary > avgScoreMike) {
    console.log('Mary\'s team wins in average! Average score: ' + avgScoreMary);
}
else {
...
john.shift(); // Removes the first element of array
console.log(john);

console.log(john.indexOf(1990)); // checks if element is in the array and returns it's index, if it's not in the array it then returns a -1
...
1) Containing all three tips (one for eah bill)
...
if (john.calcBMI() > mark.calcBMI()) {
    console.log(john.fullName + ' has a higher BMI than Mark with ' + john.bmi);
...
if (john.average > mark.average) {
    console.log(john.fullName + '\'s family had the higher tip average of $' + john.average);
} else if (mark.average > john.average) {
    console.log(mark.fullName + '\'s family had the higher tip average of $' + mark.average);
} else {
    console.log(john.fullName + '\'s ' + 'and ' + mark.fullName + '\'s families have the same tip average.');
}